...
DocumentModel _$DocumentModelFromJson(
  Map<String, dynamic> json
    ...
    return _DocumentsModel.fromJson(
      json
    );
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _DocumentsModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _DocumentsModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _DocumentsModel value)  $default,){
final _that = this;
switch (_that) {
case _DocumentsModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _DocumentsModel value)?  $default,){
final _that = this;
switch (_that) {
case _DocumentsModel() when $default != null:
return $default(_that);case _:
...
class _DocumentsModel implements DocumentModel {
  const _DocumentsModel({@JsonKey(name: 'doc_id') required this.docId, @JsonKey(name: 'id_customer') required this.memberId, @JsonKey(name: 'expire_date') required this.expireDate, @JsonKey(name: 'doc_name') required this.docName, @JsonKey(name: 'doc_type') required this.docType});
  factory _DocumentsModel.fromJson(Map<String, dynamic> json) => _$DocumentsModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$DocumentsModelCopyWith<_DocumentsModel> get copyWith => __$DocumentsModelCopyWithImpl<_DocumentsModel>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DocumentsModel&&(identical(other.docId, docId) || other.docId == docId)&&(identical(other.memberId, memberId) || other.memberId == memberId)&&(identical(other.expireDate, expireDate) || other.expireDate == expireDate)&&(identical(other.docName, docName) || other.docName == docName)&&(identical(other.docType, docType) || other.docType == docType));
}
...
/// @nodoc
abstract mixin class _$DocumentsModelCopyWith<$Res> implements $DocumentModelCopyWith<$Res> {
  factory _$DocumentsModelCopyWith(_DocumentsModel value, $Res Function(_DocumentsModel) _then) = __$DocumentsModelCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'doc_id') int docId,@JsonKey(name: 'id_customer') int memberId,@JsonKey(name: 'expire_date') DateTime expireDate,@JsonKey(name: 'doc_name') String docName,@JsonKey(name: 'doc_type') String docType
});
...
class __$DocumentsModelCopyWithImpl<$Res>
  ...
  __$DocumentsModelCopyWithImpl(this._self, this._then);

  final _DocumentsModel _self;
  final $Res Function(_DocumentsModel) _then;
