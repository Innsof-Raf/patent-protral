...
mixin _$DoctorState {
 ...
 bool get isDoctorsFetching; bool get isDoctorsFetchingFailed; bool get isDoctorsFetchingSuccess; ErrorModel get error; List<DoctorModel> get doctors;
...
@useResult
$Res call({
 bool isDoctorsFetching, bool isDoctorsFetchingFailed, bool isDoctorsFetchingSuccess, ErrorModel error, List<DoctorModel> doctors
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isDoctorsFetching,  bool isDoctorsFetchingFailed,  bool isDoctorsFetchingSuccess,  ErrorModel error,  List<DoctorModel> doctors)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DoctorState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isDoctorsFetching,  bool isDoctorsFetchingFailed,  bool isDoctorsFetchingSuccess,  ErrorModel error,  List<DoctorModel> doctors)  $default,) {final _that = this;
switch (_that) {
case _DoctorState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isDoctorsFetching,  bool isDoctorsFetchingFailed,  bool isDoctorsFetchingSuccess,  ErrorModel error,  List<DoctorModel> doctors)?  $default,) {final _that = this;
switch (_that) {
case _DoctorState() when $default != null:
return $default(_that.isDoctorsFetching,_that.isDoctorsFetchingFailed,_that.isDoctorsFetchingSuccess,_that.error,_that.doctors);case _:
  return null;
...
class _DoctorState implements DoctorState {
  const _DoctorState({required this.isDoctorsFetching, required this.isDoctorsFetchingFailed, required this.isDoctorsFetchingSuccess, required this.error, required final  List<DoctorModel> doctors}): _doctors = doctors;
