...
mixin _$SearchDoctorEvent {
 ...
 String get searchKey; List<Doctor> get doctors;
...
@useResult
$Res call({
 String searchKey, List<Doctor> doctors
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String searchKey,  List<Doctor> doctors)?  searchDoctor,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SearchDoctor() when searchDoctor != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String searchKey,  List<Doctor> doctors)  searchDoctor,}) {final _that = this;
switch (_that) {
case SearchDoctor():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String searchKey,  List<Doctor> doctors)?  searchDoctor,}) {final _that = this;
switch (_that) {
case SearchDoctor() when searchDoctor != null:
return searchDoctor(_that.searchKey,_that.doctors);case _:
  return null;
...
class SearchDoctor implements SearchDoctorEvent {
  const SearchDoctor({required this.searchKey, required final  List<Doctor> doctors}): _doctors = doctors;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Doctor> searchResult)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchDoctorState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Doctor> searchResult)  $default,) {final _that = this;
switch (_that) {
case _SearchDoctorState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Doctor> searchResult)?  $default,) {final _that = this;
switch (_that) {
case _SearchDoctorState() when $default != null:
return $default(_that.searchResult);case _:
  return null;
...
class _SearchDoctorState implements SearchDoctorState {
  const _SearchDoctorState({required final  List<Doctor> searchResult}): _searchResult = searchResult;
  

 final  List<Doctor> _searchResult;
@override List<Doctor> get searchResult {
