...
@JsonKey(name: 'employee_id', fromJson: stringFromJson) String get doctorId;@JsonKey(name: 'id_employee', fromJson: intFromJson) int get idDoctor;@JsonKey(name: 'id_busunit', fromJson: intFromJson) int get idBusUnit;@JsonKey(name: 'busunit_name', fromJson: stringFromJson) String get busUnitName;@JsonKey(name: 'employee_name', fromJson: stringFromJson) String get doctorName;@JsonKey(name: 'dept_name', fromJson: stringFromJson) String get departmentName;@JsonKey(name: 'speciality', readValue: _readDoctorSpeciality, fromJson: stringFromJson) String get doctorSpeciality;@JsonKey(fromJson: stringFromJson) String get experience;@JsonKey(fromJson: stringFromJson) String get branch;@JsonKey(name: 'Language_Known', fromJson: _languagesFromJson) List<LanguageKnownModel> get languages;@JsonKey(name: 'profileUrl', fromJson: stringFromJson) String get doctorImage;@JsonKey(name: 'cons_fee', fromJson: doubleFromJson) double get consultationFee;@JsonKey(name: 'online_cons_fee', fromJson: doubleFromJson) double get onlineConsultationFee;@JsonKey(name: 'isOnline', fromJson: boolFromJson) bool get isOnline;@JsonKey(name: 'employee_bio', fromJson: _nullableStringFromJson) String? get doctorBio;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,doctorId,idDoctor,idBusUnit,busUnitName,doctorName,departmentName,doctorSpeciality,experience,branch,const DeepCollectionEquality().hash(languages),doctorImage,consultationFee,onlineConsultationFee,isOnline,doctorBio);

@override
String toString() {
  return 'DoctorModel(doctorId: $doctorId, idDoctor: $idDoctor, idBusUnit: $idBusUnit, busUnitName: $busUnitName, doctorName: $doctorName, departmentName: $departmentName, doctorSpeciality: $doctorSpeciality, experience: $experience, branch: $branch, languages: $languages, doctorImage: $doctorImage, consultationFee: $consultationFee, onlineConsultationFee: $onlineConsultationFee, isOnline: $isOnline, doctorBio: $doctorBio)';
}
...
@useResult
$Res call({
@JsonKey(name: 'employee_id', fromJson: stringFromJson) String doctorId,@JsonKey(name: 'id_employee', fromJson: intFromJson) int idDoctor,@JsonKey(name: 'id_busunit', fromJson: intFromJson) int idBusUnit,@JsonKey(name: 'busunit_name', fromJson: stringFromJson) String busUnitName,@JsonKey(name: 'employee_name', fromJson: stringFromJson) String doctorName,@JsonKey(name: 'dept_name', fromJson: stringFromJson) String departmentName,@JsonKey(name: 'speciality', readValue: _readDoctorSpeciality, fromJson: stringFromJson) String doctorSpeciality,@JsonKey(fromJson: stringFromJson) String experience,@JsonKey(fromJson: stringFromJson) String branch,@JsonKey(name: 'Language_Known', fromJson: _languagesFromJson) List<LanguageKnownModel> languages,@JsonKey(name: 'profileUrl', fromJson: stringFromJson) String doctorImage,@JsonKey(name: 'cons_fee', fromJson: doubleFromJson) double consultationFee,@JsonKey(name: 'online_cons_fee', fromJson: doubleFromJson) double onlineConsultationFee,@JsonKey(name: 'isOnline', fromJson: boolFromJson) bool isOnline,@JsonKey(name: 'employee_bio', fromJson: _nullableStringFromJson) String? doctorBio
});
...
switch (_that) {
case _DoctorModel() when $default != null:
return $default(_that.doctorId,_that.idDoctor,_that.idBusUnit,_that.busUnitName,_that.doctorName,_that.departmentName,_that.doctorSpeciality,_that.experience,_that.branch,_that.languages,_that.doctorImage,_that.consultationFee,_that.onlineConsultationFee,_that.isOnline,_that.doctorBio);case _:
  return orElse();
...
switch (_that) {
case _DoctorModel():
return $default(_that.doctorId,_that.idDoctor,_that.idBusUnit,_that.busUnitName,_that.doctorName,_that.departmentName,_that.doctorSpeciality,_that.experience,_that.branch,_that.languages,_that.doctorImage,_that.consultationFee,_that.onlineConsultationFee,_that.isOnline,_that.doctorBio);}
}
...
@override@JsonKey(name: 'Language_Known', fromJson: _languagesFromJson) List<LanguageKnownModel> get languages {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,doctorId,idDoctor,idBusUnit,busUnitName,doctorName,departmentName,doctorSpeciality,experience,branch,const DeepCollectionEquality().hash(_languages),doctorImage,consultationFee,onlineConsultationFee,isOnline,doctorBio);
