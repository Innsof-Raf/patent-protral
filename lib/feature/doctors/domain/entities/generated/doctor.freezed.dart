...
mixin _$Doctor {
 ...
 String get doctorId; int get idDoctor; int get idDept; int get idBusUnit; String get busUnitName; String get doctorName; String get departmentName; String get doctorSpeciality; String get experience; String get branch; List<String> get knownLanguages; String get doctorImage; double get consultationFee; double get onlineConsultationFee; bool get isOnline; String get availability; String? get doctorBio;
...
@override
int get hashCode => Object.hash(runtimeType,doctorId,idDoctor,idDept,idBusUnit,busUnitName,doctorName,departmentName,doctorSpeciality,experience,branch,const DeepCollectionEquality().hash(knownLanguages),doctorImage,consultationFee,onlineConsultationFee,isOnline,availability,doctorBio);
...
/// Create a copy of Doctor
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? doctorId = null,Object? idDoctor = null,Object? idDept = null,Object? idBusUnit = null,Object? busUnitName = null,Object? doctorName = null,Object? departmentName = null,Object? doctorSpeciality = null,Object? experience = null,Object? branch = null,Object? knownLanguages = null,Object? doctorImage = null,Object? consultationFee = null,Object? onlineConsultationFee = null,Object? isOnline = null,Object? availability = null,Object? doctorBio = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String doctorId,  int idDoctor,  int idDept,  int idBusUnit,  String busUnitName,  String doctorName,  String departmentName,  String doctorSpeciality,  String experience,  String branch,  List<String> knownLanguages,  String doctorImage,  double consultationFee,  double onlineConsultationFee,  bool isOnline,  String availability,  String? doctorBio)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Doctor() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String doctorId,  int idDoctor,  int idDept,  int idBusUnit,  String busUnitName,  String doctorName,  String departmentName,  String doctorSpeciality,  String experience,  String branch,  List<String> knownLanguages,  String doctorImage,  double consultationFee,  double onlineConsultationFee,  bool isOnline,  String availability,  String? doctorBio)  $default,) {final _that = this;
switch (_that) {
case _Doctor():
...
class _Doctor implements Doctor {
  const _Doctor({required this.doctorId, required this.idDoctor, required this.idDept, required this.idBusUnit, required this.busUnitName, required this.doctorName, required this.departmentName, required this.doctorSpeciality, required this.experience, required this.branch, required final  List<String> knownLanguages, required this.doctorImage, required this.consultationFee, required this.onlineConsultationFee, required this.isOnline, this.availability = '', this.doctorBio}): _knownLanguages = knownLanguages;
...
@override
int get hashCode => Object.hash(runtimeType,doctorId,idDoctor,idDept,idBusUnit,busUnitName,doctorName,departmentName,doctorSpeciality,experience,branch,const DeepCollectionEquality().hash(_knownLanguages),doctorImage,consultationFee,onlineConsultationFee,isOnline,availability,doctorBio);
