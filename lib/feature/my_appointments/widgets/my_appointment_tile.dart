                              ...
                              onPressed: () {
                                if (!appointment.isCanceling) {
                                  ...
                                  BookAppointmentScreenHelpers
                                      ...
                                      BookAppointmentScreenHelpers.dateList
                                          .firstWhere((date) =>
                                              date.day ==
                                              appointment
                                        ...
                                        transitionBuilder: (context,
                                            ...
                                            Transform.scale(
                                              ...
                                              child: CancelBookingPopUp(
                                                appintmentDateTime: appointment
                                                    .appointmentDateTime,
                    ...
                    : ActiveButton(
                        ...
                        onPressed: () {
                          ...
                          BookAppointmentScreenHelpers.selectedDateNotifier
                              .value = BookAppointmentScreenHelpers.dateList[0];
                          Navigator.of(context).pushNamed(
                              RouteConstants.bookAppointmentScreen,
                              arguments: {
                                'doctor_name': appointment.doctorName,
