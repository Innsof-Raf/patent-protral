...
mixin _$SlotModel {
  ...
  @JsonKey(name: "tod")
  String get tod => throw _privateConstructorUsedError;
...
class _$SlotModelCopyWithImpl<$Res> implements $SlotModelCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      tod: tod == freezed
          ? _value.tod
          : tod // ignore: cast_nullable_to_non_nullable
              as String,
    ));
  }
}
...
class _$_SlotModel implements _SlotModel {
  const _$_SlotModel(
      ...
      @JsonKey(name: "tod") required this.tod});
  ...
  @override
  String toString() {
    return 'SlotModel(id: $id, label: $label, appdttm: $appdttm, tod: $tod)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.tod, tod));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(tod));
...
abstract class _SlotModel implements SlotModel {
  const factory _SlotModel(
      ...
      @JsonKey(name: "tod") required final String tod}) = _$_SlotModel;
