                    ...
                    if (appointmentId == 0) {
                        ...
                        context.read<MyAppointmentsBloc>().add(
                            StoreBokkedApoointment(
                                appointment: MyAppointmentModel(
                                    ...
                                    departName:
                                        state.appointmentDetails!.deptName,
                                    doctorId:
                                        state.appointmentDetails!.doctorId,
                                    doctorName:
                                        state.appointmentDetails!.doctorName,
                                    email: state.appointmentDetails!.email,
                                    id: state.appointmentDetails!.id,
                                    idDoctor:
                                        state.appointmentDetails!.idDoctor,
                                    memberId:
                                        state.appointmentDetails!.idMember,
                                    memberName:
                                    ...
                                    speciality: state
                                        .appointmentDetails!.doctorSpecility,
                                    isCanceling: false)));
                        context.read<SlotBloc>().add(ChangeBookedSlotState(
                            slotTime:
                      ...
                      showGeneralDialog(
                        ...
                        final MyAppointmentModel selectedAppointment = context
                            ...
                            .state
                            .myAppointments
                            .singleWhere((appointment) =>
                                appointment.id == appointmentId);

                        context.read<SlotBloc>().add(ChangeResheduledSlotState(
