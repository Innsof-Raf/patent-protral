...
import 'widgets/add_attachments_section.dart';
                      ...
                      children: [
                        ...
                        ValueListenableBuilder(
                          ...
                          builder: (context, value, child) =>
                            ...
                            onChanged: () {
                              InsuranceHelpers
                                  .insuranceCheackBoxNotifier.value = !value;
                            },
              ...
              ValueListenableBuilder(
                ...
                builder: (context, value, child) => value
                    ? InsuranceFormSection(
                        idInsurance:
                            member != null ? member!.insuranceId : null,
                        insuranceName:
                            member != null && member!.insuranceId == 0
                                ? member!.insuranceName
                                : null,
                        memberInsuranvceExpireDate:
                            member != null ? member!.insuranceExpDttm : null,
                        memberNumber: member != null ? member!.memberNo : null,
                      )
                    : const SizedBox(
                        height: 55,
                      ),
                  ...
                  onPressed: () {
                    if (!state.isMemberAdding) {
                      if (member != null) {
                        ...
                        AddMemberScreenHelpers.saveMember(
                          context: context,
                        );
                      }
                    }
