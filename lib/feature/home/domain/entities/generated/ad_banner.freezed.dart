...
@override
String toString() {
  return 'AdBanner(imageName: $imageName, url: $url, idPrimary: $idPrimary, bannerType: $bannerType)';
}
...
class _AdBanner implements AdBanner {
  const _AdBanner({required this.imageName, required this.url, required this.idPrimary, required this.bannerType});
