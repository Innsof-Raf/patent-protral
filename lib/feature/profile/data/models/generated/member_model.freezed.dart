...
@JsonKey(name: "Id") int get id;@JsonKey(name: "Name") String get name;@JsonKey(name: "MobileNo") String? get mobileNo;@JsonKey(name: "EmailID") String? get emailId;@JsonKey(name: "Age") String get age;@JsonKey(name: "SSN") String get nationalId;@JsonKey(name: "Profile_Img") String? get profileImage;@JsonKey(name: "Is_Insu") bool get isInsurance;@JsonKey(name: "Is_InsuExpired") bool get isInsuranceExpired;@JsonKey(name: "Insur_Exp") DateTime? get insuranceExpDttm;@JsonKey(name: "Dob") DateTime? get dob;@JsonKey(name: "member_no") String? get memberNo;@JsonKey(name: "insur_name") String? get insuranceName;@JsonKey(name: "insu_id") int? get insuranceId;@JsonKey(name: "Gender") String? get gender;@JsonKey(name: 'docs') List<MmemberDocumentModel> get memberDocs; bool get isSelected;
...
@useResult
$Res call({
@JsonKey(name: "Id") int id,@JsonKey(name: "Name") String name,@JsonKey(name: "MobileNo") String? mobileNo,@JsonKey(name: "EmailID") String? emailId,@JsonKey(name: "Age") String age,@JsonKey(name: "SSN") String nationalId,@JsonKey(name: "Profile_Img") String? profileImage,@JsonKey(name: "Is_Insu") bool isInsurance,@JsonKey(name: "Is_InsuExpired") bool isInsuranceExpired,@JsonKey(name: "Insur_Exp") DateTime? insuranceExpDttm,@JsonKey(name: "Dob") DateTime? dob,@JsonKey(name: "member_no") String? memberNo,@JsonKey(name: "insur_name") String? insuranceName,@JsonKey(name: "insu_id") int? insuranceId,@JsonKey(name: "Gender") String? gender,@JsonKey(name: 'docs') List<MmemberDocumentModel> memberDocs, bool isSelected
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "Id")  int id, @JsonKey(name: "Name")  String name, @JsonKey(name: "MobileNo")  String? mobileNo, @JsonKey(name: "EmailID")  String? emailId, @JsonKey(name: "Age")  String age, @JsonKey(name: "SSN")  String nationalId, @JsonKey(name: "Profile_Img")  String? profileImage, @JsonKey(name: "Is_Insu")  bool isInsurance, @JsonKey(name: "Is_InsuExpired")  bool isInsuranceExpired, @JsonKey(name: "Insur_Exp")  DateTime? insuranceExpDttm, @JsonKey(name: "Dob")  DateTime? dob, @JsonKey(name: "member_no")  String? memberNo, @JsonKey(name: "insur_name")  String? insuranceName, @JsonKey(name: "insu_id")  int? insuranceId, @JsonKey(name: "Gender")  String? gender, @JsonKey(name: 'docs')  List<MmemberDocumentModel> memberDocs,  bool isSelected)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MemberModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "Id")  int id, @JsonKey(name: "Name")  String name, @JsonKey(name: "MobileNo")  String? mobileNo, @JsonKey(name: "EmailID")  String? emailId, @JsonKey(name: "Age")  String age, @JsonKey(name: "SSN")  String nationalId, @JsonKey(name: "Profile_Img")  String? profileImage, @JsonKey(name: "Is_Insu")  bool isInsurance, @JsonKey(name: "Is_InsuExpired")  bool isInsuranceExpired, @JsonKey(name: "Insur_Exp")  DateTime? insuranceExpDttm, @JsonKey(name: "Dob")  DateTime? dob, @JsonKey(name: "member_no")  String? memberNo, @JsonKey(name: "insur_name")  String? insuranceName, @JsonKey(name: "insu_id")  int? insuranceId, @JsonKey(name: "Gender")  String? gender, @JsonKey(name: 'docs')  List<MmemberDocumentModel> memberDocs,  bool isSelected)  $default,) {final _that = this;
switch (_that) {
case _MemberModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "Id")  int id, @JsonKey(name: "Name")  String name, @JsonKey(name: "MobileNo")  String? mobileNo, @JsonKey(name: "EmailID")  String? emailId, @JsonKey(name: "Age")  String age, @JsonKey(name: "SSN")  String nationalId, @JsonKey(name: "Profile_Img")  String? profileImage, @JsonKey(name: "Is_Insu")  bool isInsurance, @JsonKey(name: "Is_InsuExpired")  bool isInsuranceExpired, @JsonKey(name: "Insur_Exp")  DateTime? insuranceExpDttm, @JsonKey(name: "Dob")  DateTime? dob, @JsonKey(name: "member_no")  String? memberNo, @JsonKey(name: "insur_name")  String? insuranceName, @JsonKey(name: "insu_id")  int? insuranceId, @JsonKey(name: "Gender")  String? gender, @JsonKey(name: 'docs')  List<MmemberDocumentModel> memberDocs,  bool isSelected)?  $default,) {final _that = this;
switch (_that) {
case _MemberModel() when $default != null:
return $default(_that.id,_that.name,_that.mobileNo,_that.emailId,_that.age,_that.nationalId,_that.profileImage,_that.isInsurance,_that.isInsuranceExpired,_that.insuranceExpDttm,_that.dob,_that.memberNo,_that.insuranceName,_that.insuranceId,_that.gender,_that.memberDocs,_that.isSelected);case _:
  return null;
...
@override@JsonKey(name: "SSN") final  String nationalId;
@override@JsonKey(name: "Profile_Img") final  String? profileImage;
@override@JsonKey(name: "Is_Insu") final  bool isInsurance;
@override@JsonKey(name: "Is_InsuExpired") final  bool isInsuranceExpired;
@override@JsonKey(name: "Insur_Exp") final  DateTime? insuranceExpDttm;
@override@JsonKey(name: "Dob") final  DateTime? dob;
@override@JsonKey(name: "member_no") final  String? memberNo;
@override@JsonKey(name: "insur_name") final  String? insuranceName;
@override@JsonKey(name: "insu_id") final  int? insuranceId;
