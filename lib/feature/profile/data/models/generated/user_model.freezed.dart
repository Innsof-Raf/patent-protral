...
@JsonKey(name: 'Id', fromJson: intFromJson) int get id;@JsonKey(name: 'FirstName') String get firstName;@JsonKey(name: 'LastName') String get lastName;@JsonKey(name: 'Username') String get userName;@JsonKey(name: 'MobileNo') String get mobileNumber;@JsonKey(name: 'EmailID') String get emailId;@JsonKey(name: 'accessToken') String get accessToken;@JsonKey(name: 'refreshToken') String get refreshToken;@JsonKey(name: 'FCM_Token') String get fcmToken;@JsonKey(name: 'Members') List<MemberModel> get members;@JsonKey(name: 'IdMember', fromJson: intFromJson) int get idMember;
...
@override
String toString() {
  return 'UserModel(id: $id, firstName: $firstName, lastName: $lastName, userName: $userName, mobileNumber: $mobileNumber, emailId: $emailId, accessToken: $accessToken, refreshToken: $refreshToken, fcmToken: $fcmToken, members: $members, idMember: $idMember)';
}
...
@useResult
$Res call({
@JsonKey(name: 'Id', fromJson: intFromJson) int id,@JsonKey(name: 'FirstName') String firstName,@JsonKey(name: 'LastName') String lastName,@JsonKey(name: 'Username') String userName,@JsonKey(name: 'MobileNo') String mobileNumber,@JsonKey(name: 'EmailID') String emailId,@JsonKey(name: 'accessToken') String accessToken,@JsonKey(name: 'refreshToken') String refreshToken,@JsonKey(name: 'FCM_Token') String fcmToken,@JsonKey(name: 'Members') List<MemberModel> members,@JsonKey(name: 'IdMember', fromJson: intFromJson) int idMember
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'Id', fromJson: intFromJson)  int id, @JsonKey(name: 'FirstName')  String firstName, @JsonKey(name: 'LastName')  String lastName, @JsonKey(name: 'Username')  String userName, @JsonKey(name: 'MobileNo')  String mobileNumber, @JsonKey(name: 'EmailID')  String emailId, @JsonKey(name: 'accessToken')  String accessToken, @JsonKey(name: 'refreshToken')  String refreshToken, @JsonKey(name: 'FCM_Token')  String fcmToken, @JsonKey(name: 'Members')  List<MemberModel> members, @JsonKey(name: 'IdMember', fromJson: intFromJson)  int idMember)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'Id', fromJson: intFromJson)  int id, @JsonKey(name: 'FirstName')  String firstName, @JsonKey(name: 'LastName')  String lastName, @JsonKey(name: 'Username')  String userName, @JsonKey(name: 'MobileNo')  String mobileNumber, @JsonKey(name: 'EmailID')  String emailId, @JsonKey(name: 'accessToken')  String accessToken, @JsonKey(name: 'refreshToken')  String refreshToken, @JsonKey(name: 'FCM_Token')  String fcmToken, @JsonKey(name: 'Members')  List<MemberModel> members, @JsonKey(name: 'IdMember', fromJson: intFromJson)  int idMember)  $default,) {final _that = this;
switch (_that) {
case _UserModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'Id', fromJson: intFromJson)  int id, @JsonKey(name: 'FirstName')  String firstName, @JsonKey(name: 'LastName')  String lastName, @JsonKey(name: 'Username')  String userName, @JsonKey(name: 'MobileNo')  String mobileNumber, @JsonKey(name: 'EmailID')  String emailId, @JsonKey(name: 'accessToken')  String accessToken, @JsonKey(name: 'refreshToken')  String refreshToken, @JsonKey(name: 'FCM_Token')  String fcmToken, @JsonKey(name: 'Members')  List<MemberModel> members, @JsonKey(name: 'IdMember', fromJson: intFromJson)  int idMember)?  $default,) {final _that = this;
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.id,_that.firstName,_that.lastName,_that.userName,_that.mobileNumber,_that.emailId,_that.accessToken,_that.refreshToken,_that.fcmToken,_that.members,_that.idMember);case _:
  return null;
...
class _UserModel extends UserModel {
  const _UserModel({@JsonKey(name: 'Id', fromJson: intFromJson) required this.id, @JsonKey(name: 'FirstName') this.firstName = '', @JsonKey(name: 'LastName') this.lastName = '', @JsonKey(name: 'Username') this.userName = '', @JsonKey(name: 'MobileNo') this.mobileNumber = '', @JsonKey(name: 'EmailID') this.emailId = '', @JsonKey(name: 'accessToken') required this.accessToken, @JsonKey(name: 'refreshToken') this.refreshToken = '', @JsonKey(name: 'FCM_Token') this.fcmToken = '', @JsonKey(name: 'Members') final  List<MemberModel> members = const [], @JsonKey(name: 'IdMember', fromJson: intFromJson) this.idMember = 0}): _members = members,super._();
