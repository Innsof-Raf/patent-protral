...
class RefreshToken implements UserEvent {
  const RefreshToken();
...
as bool,isMemberAdding: null == isMemberAdding ? _self.isMemberAdding : isMemberAdding // ignore: cast_nullable_to_non_nullable
