...
@override
String toString() {
  return 'Item(idItem: $idItem, itemNmae: $itemNmae, itemPrice: $itemPrice, itemImg: $itemImg, itemShortDesc: $itemShortDesc, itemType: $itemType, isCart: $isCart, isChangingCartStatus: $isChangingCartStatus)';
}
...
class _Item implements Item {
  const _Item({required this.idItem, required this.itemNmae, required this.itemPrice, required this.itemImg, required this.itemShortDesc, required this.itemType, required this.isCart, this.isChangingCartStatus = false});
