...
class _PackageModel implements PackageModel {
  const _PackageModel({required this.id, @JsonKey(name: 'pkg_name') required this.pkgName, @JsonKey(name: 'pkg_price') required this.pkgPrice, @JsonKey(name: 'pkg_img') required this.pkgImage});
