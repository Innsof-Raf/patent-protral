...
mixin _$ItemsState {
  ...
  List<ItemModel> get cart => throw _privateConstructorUsedError;
...
class _$_ItemState implements _ItemState {
  const _$_ItemState(
      ...
      required final List<ItemModel> cart})
      : _items = items,
        _cart = cart;
...
abstract class _ItemState implements ItemsState {
  const factory _ItemState(
      ...
      required final List<ItemModel> items,
      required final List<ItemModel> cart}) = _$_ItemState;
