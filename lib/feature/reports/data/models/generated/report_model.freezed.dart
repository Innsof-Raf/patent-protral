...
@JsonKey(name: 'id_cons', fromJson: intFromJson) int get idConseltation;@JsonKey(name: 'id', fromJson: intFromJson) int get id;@JsonKey(name: 'ID_CUSTOMER', fromJson: intFromJson) int get memberId;@JsonKey(name: 'employee_name', fromJson: stringFromJson) String get doctorName;@JsonKey(name: 'speciality', fromJson: stringFromJson) String get departmentName;@JsonKey(name: 'appmnt_dttm') DateTime get appointmentDate;@JsonKey(name: 'appmnt_time', fromJson: stringFromJson) String get appointmentTime;@JsonKey(name: 'labreport_url') String? get labPdfUrl;@JsonKey(name: 'xrayreport_url') String? get xRayPdfUrl;@JsonKey(name: 'ussreport_url') String? get ussPdfUrl;@JsonKey(name: 'ct_url') String? get ctPdfUrl;
...
@useResult
$Res call({
@JsonKey(name: 'id_cons', fromJson: intFromJson) int idConseltation,@JsonKey(name: 'id', fromJson: intFromJson) int id,@JsonKey(name: 'ID_CUSTOMER', fromJson: intFromJson) int memberId,@JsonKey(name: 'employee_name', fromJson: stringFromJson) String doctorName,@JsonKey(name: 'speciality', fromJson: stringFromJson) String departmentName,@JsonKey(name: 'appmnt_dttm') DateTime appointmentDate,@JsonKey(name: 'appmnt_time', fromJson: stringFromJson) String appointmentTime,@JsonKey(name: 'labreport_url') String? labPdfUrl,@JsonKey(name: 'xrayreport_url') String? xRayPdfUrl,@JsonKey(name: 'ussreport_url') String? ussPdfUrl,@JsonKey(name: 'ct_url') String? ctPdfUrl
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id_cons', fromJson: intFromJson)  int idConseltation, @JsonKey(name: 'id', fromJson: intFromJson)  int id, @JsonKey(name: 'ID_CUSTOMER', fromJson: intFromJson)  int memberId, @JsonKey(name: 'employee_name', fromJson: stringFromJson)  String doctorName, @JsonKey(name: 'speciality', fromJson: stringFromJson)  String departmentName, @JsonKey(name: 'appmnt_dttm')  DateTime appointmentDate, @JsonKey(name: 'appmnt_time', fromJson: stringFromJson)  String appointmentTime, @JsonKey(name: 'labreport_url')  String? labPdfUrl, @JsonKey(name: 'xrayreport_url')  String? xRayPdfUrl, @JsonKey(name: 'ussreport_url')  String? ussPdfUrl, @JsonKey(name: 'ct_url')  String? ctPdfUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReportModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id_cons', fromJson: intFromJson)  int idConseltation, @JsonKey(name: 'id', fromJson: intFromJson)  int id, @JsonKey(name: 'ID_CUSTOMER', fromJson: intFromJson)  int memberId, @JsonKey(name: 'employee_name', fromJson: stringFromJson)  String doctorName, @JsonKey(name: 'speciality', fromJson: stringFromJson)  String departmentName, @JsonKey(name: 'appmnt_dttm')  DateTime appointmentDate, @JsonKey(name: 'appmnt_time', fromJson: stringFromJson)  String appointmentTime, @JsonKey(name: 'labreport_url')  String? labPdfUrl, @JsonKey(name: 'xrayreport_url')  String? xRayPdfUrl, @JsonKey(name: 'ussreport_url')  String? ussPdfUrl, @JsonKey(name: 'ct_url')  String? ctPdfUrl)  $default,) {final _that = this;
switch (_that) {
case _ReportModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'id_cons', fromJson: intFromJson)  int idConseltation, @JsonKey(name: 'id', fromJson: intFromJson)  int id, @JsonKey(name: 'ID_CUSTOMER', fromJson: intFromJson)  int memberId, @JsonKey(name: 'employee_name', fromJson: stringFromJson)  String doctorName, @JsonKey(name: 'speciality', fromJson: stringFromJson)  String departmentName, @JsonKey(name: 'appmnt_dttm')  DateTime appointmentDate, @JsonKey(name: 'appmnt_time', fromJson: stringFromJson)  String appointmentTime, @JsonKey(name: 'labreport_url')  String? labPdfUrl, @JsonKey(name: 'xrayreport_url')  String? xRayPdfUrl, @JsonKey(name: 'ussreport_url')  String? ussPdfUrl, @JsonKey(name: 'ct_url')  String? ctPdfUrl)?  $default,) {final _that = this;
switch (_that) {
case _ReportModel() when $default != null:
return $default(_that.idConseltation,_that.id,_that.memberId,_that.doctorName,_that.departmentName,_that.appointmentDate,_that.appointmentTime,_that.labPdfUrl,_that.xRayPdfUrl,_that.ussPdfUrl,_that.ctPdfUrl);case _:
  return null;
...
class _ReportModel extends ReportModel {
  const _ReportModel({@JsonKey(name: 'id_cons', fromJson: intFromJson) required this.idConseltation, @JsonKey(name: 'id', fromJson: intFromJson) required this.id, @JsonKey(name: 'ID_CUSTOMER', fromJson: intFromJson) required this.memberId, @JsonKey(name: 'employee_name', fromJson: stringFromJson) required this.doctorName, @JsonKey(name: 'speciality', fromJson: stringFromJson) required this.departmentName, @JsonKey(name: 'appmnt_dttm') required this.appointmentDate, @JsonKey(name: 'appmnt_time', fromJson: stringFromJson) required this.appointmentTime, @JsonKey(name: 'labreport_url') this.labPdfUrl, @JsonKey(name: 'xrayreport_url') this.xRayPdfUrl, @JsonKey(name: 'ussreport_url') this.ussPdfUrl, @JsonKey(name: 'ct_url') this.ctPdfUrl}): super._();
