...
class LogInScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        if (LoginScreenHelpers.loginSectionNotifer.value == 1) {
          LoginScreenHelpers.loginSectionNotifer.value = 0;
          return false;
        } else if (LoginScreenHelpers.loginSectionNotifer.value == 2) {
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: ValueListenableBuilder(
                        ...
                        builder: (context, index, _) => AnimatedSmoothIndicator(
                              onDotClicked: (index) {
                                bagroundImageCarouselController
                                    .animateToPage(index);
                              },
                  ...
                  Container(
                    width: double.infinity,
                    padding:
                        const EdgeInsets.all(LoginScreenHelpers.constPadding),
                    decoration: const BoxDecoration(
