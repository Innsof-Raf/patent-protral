...
class _AppointmentModel implements AppointmentModel {
  const _AppointmentModel({@JsonKey(readValue: _readId, fromJson: intFromJson) required this.id, @JsonKey(name: "appmt_id") this.appointmentId = '', @JsonKey(name: "branch") this.branch = '', @JsonKey(readValue: _readIdMember, fromJson: intFromJson) required this.idMember, @JsonKey(readValue: _readMemberName, fromJson: stringFromJson) required this.memberName, @JsonKey(readValue: _readIdDoctor, fromJson: intFromJson) required this.idDoctor, @JsonKey(readValue: _readDoctorName, fromJson: stringFromJson) required this.doctorName, @JsonKey(name: "speciality") this.doctorSpecility = '', @JsonKey(readValue: _readDoctorImage, fromJson: stringFromJson) required this.doctorImage, @JsonKey(name: "Appmnt_Dttm") required this.appointmentDateTime, @JsonKey(name: "customer_img") this.memberImage = null, @JsonKey(readValue: _readBusunitName, fromJson: stringFromJson) required this.busunitName, @JsonKey(name: "dept_name") this.deptName = '', @JsonKey(readValue: _readEmail, fromJson: stringFromJson) required this.email, @JsonKey(name: "employee_id", fromJson: stringFromJson) this.doctorId = '', @JsonKey(readValue: _readMobileNo, fromJson: stringFromJson) required this.mobileNo, @JsonKey(readValue: _readIdBusunit, fromJson: intFromJson) required this.idBusunit, @JsonKey(name: "id_dept", fromJson: intFromJson) this.idDept = 0});
