class ConstantUrls {
  ...
  static const String bannerImageUrl = '$baseUrl/Uploads/promo/ads';
  ...
  static const String loginWithPasswordUrl = "$baseUrl/api/user/ppauthpwd";
  static const String uploadDocumentUrl = '$baseUrl/api/file/UploadDocument';
