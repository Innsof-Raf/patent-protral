...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( LoadLanguage value)?  loadLanguage,TResult Function( ChangeLanguage value)?  changeLanguage,required TResult orElse(),}){
final _that = this;
switch (_that) {
case LoadLanguage() when loadLanguage != null:
return loadLanguage(_that);case ChangeLanguage() when changeLanguage != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( LoadLanguage value)  loadLanguage,required TResult Function( ChangeLanguage value)  changeLanguage,}){
final _that = this;
switch (_that) {
case LoadLanguage():
return loadLanguage(_that);case ChangeLanguage():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( LoadLanguage value)?  loadLanguage,TResult? Function( ChangeLanguage value)?  changeLanguage,}){
final _that = this;
switch (_that) {
case LoadLanguage() when loadLanguage != null:
return loadLanguage(_that);case ChangeLanguage() when changeLanguage != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loadLanguage,TResult Function( Locale locale)?  changeLanguage,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LoadLanguage() when loadLanguage != null:
return loadLanguage();case ChangeLanguage() when changeLanguage != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loadLanguage,required TResult Function( Locale locale)  changeLanguage,}) {final _that = this;
switch (_that) {
case LoadLanguage():
return loadLanguage();case ChangeLanguage():
return changeLanguage(_that.locale);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loadLanguage,TResult? Function( Locale locale)?  changeLanguage,}) {final _that = this;
switch (_that) {
case LoadLanguage() when loadLanguage != null:
return loadLanguage();case ChangeLanguage() when changeLanguage != null:
return changeLanguage(_that.locale);case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChangeLanguage&&(identical(other.locale, locale) || other.locale == locale));
}
